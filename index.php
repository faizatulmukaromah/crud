...
<html lang="en">
  <head>
    ...
    <title>Sistem Informasi Jurusan Teknik Informatika</title>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2021 Sistem Informasi Jurusan Teknik Informatika : Nimas Ayuningtyas
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
